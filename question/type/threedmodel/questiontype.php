...
/**
 * Question type class for the threedmodel 'question' type.
 *
 * @package    qtype
...
/**
 * The threedmodel 'question' type.
 *
 * @copyright  1999 onwards Martin Dougiamas  {@link http://moodle.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_threedmodel extends question_type {
...
//        // Make very sure that threedmodels can'e be created with a grade of
//        // anything other than 0.
//        file_save_draft_area_files($form->files, $form->context->id, 'qtype_threedmodel', 'threedmodel', $form->id, array('subdirs' => 1, 'maxbytes' => 0, 'maxfiles' => 10));
//
//        $form->defaultmark = 0;
...
//    }
    ...
    public function actual_number_of_questions($question) {
        ...
        // The question type threedmodel is not even a question
