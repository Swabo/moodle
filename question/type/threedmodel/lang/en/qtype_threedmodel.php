...
/**
 * Strings for component 'qtype_threedmodel', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
...
$string['pluginname_help'] = 'A threedmodel is not really a question type. It simply enables text to be displayed without requiring any answers, similar to a label on the course page.
...
$string['pluginnameadding'] = 'Adding a threedmodel';
$string['pluginnameediting'] = 'Editing a threedmodel';
